    ...
    if (useNodeJS) {
        fetch('/send-id')
            ...
            .then(function(jsonResponse) {
                ...
                initializeLiffOrDie(myLiffId,jsonResponse);
            })
...
*/
function initializeLiffOrDie(myLiffId,json) {
    if (!myLiffId) {
        document.getElementById("liffAppContent").classList.add('hidden');
        document.getElementById("liffIdErrorMessage").classList.remove('hidden');
    } else {
        initializeLiff(myLiffId,json);
    }
}
...
* @param {string} myLiffId The LIFF ID of the selected element
*/
function initializeLiff(myLiffId,json) {
    liff
        .init({
            liffId: myLiffId
        })
...
*/
function registerButtonHandlers(json) {
    // openWindow call
